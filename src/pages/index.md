...
A JWT can be generated within the UI or generated by code using several [tools/libraries](https://jwt.io/libraries). If the payload for signing is created using these tools, ensure the JWT payload is formatted as is shown in Developer Console:
